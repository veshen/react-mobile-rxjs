...
const Page:FunctionComponent<{toDoList:[ListItem], addTodoListItem:(text:string)=>void,fetchTodoList:()=>void}> = ({toDoList, addTodoListItem,fetchTodoList}) => {
